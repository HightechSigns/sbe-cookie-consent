...
function createTestCookie() {
    console.log('creating test cookie')
    Cookies.set('assentailOne', 'test cookie')
    Cookies.set('nonAssentailOne', 'test cookie')
    Cookies.set('nonAssentailTwo', 'test cookie')
    Cookies.set('nonAssentailThree', 'test cookie')
}
// cookie list
...
const cookieList = [
    {
        c_importance: "sbe-sn",
        cookies: ['assentailOne']
    },
    {
        c_importance: "sbe-pc",
        cookies: ['nonAssentailOne', 'nonAssentailTwo', 'nonAssentailThree']
    }
]
...
const foundUserAction = (foundUser) => {
    ...
    console.info('Found a previous visitor: ', foundUser, " Setting cookie settings.")
...
const checkCheckBoxes = (t, t_id) => {
    ...
    console.log('checked check boxes and updated Active user: ', activeUser)
}
// set user pop
...
$(function () {
    ...
    checkboxes.on('change', (e) => {
        ...
        console.log('cookie ' + t_id + ' changed: ' + $(t).is(':checked'))
        checkCheckBoxes(t, t_id)
        // take "disabled" off confirm settings btn 
        console.log('checkbox changed and about to make Confirm button active: ' + confirmChosenCookiesBtnElm.is('disabled'))
